...
namespace XnaSpaceSimulator
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            var effect = Content.Load<Effect>("MultitextureTerrainEffect");
            effect.Parameters["WeightMap"].SetValue(Content.Load<Texture2D>("WeightMap"));
            effect.Parameters["BaseTexture"].SetValue(Content.Load<Texture2D>("grass"));
            effect.Parameters["RTexture"].SetValue(Content.Load<Texture2D>("sand"));
            effect.Parameters["GTexture"].SetValue(Content.Load<Texture2D>("rock"));
            effect.Parameters["BTexture"].SetValue(Content.Load<Texture2D>("snow"));
